...
const FEATURES = [
  'Write, run & submit C right in the browser',
      ...
      >
        ...
        <div className="relative max-w-md">
          <h1 className="text-white font-serif font-semibold text-[34px] leading-[1.15] tracking-tight">
            Master C, one problem at a time.
          </h1>
          <p className="text-white/80 mt-4 text-[15px] leading-relaxed">
            A focused workspace to learn C — write code, get instant feedback, and actually <em>see</em> how your program runs.
          </p>
        ...
        <p className="relative text-white/55 text-xs">© CodeForge · C Programming Platform</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10 relative">
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="lg:hidden flex flex-col items-center mb-8">
            ...
            <p className="text-t3 text-[13px] mt-0.5">C Programming Platform</p>
          </div>
          {children}
        </div>
      </div>
