...
const NEW_BLOCK = {
  ...
  example: () => ({ type: 'example', title: 'Run this', code: '#include <stdio.h>\n\nint main() {\n    \n    return 0;\n}\n', stdin: '' }),
            ...
            <div key={i} className="rounded-lg border border-line p-3 surface-inset">
              ...
              {b.type === 'example' && (
                <div className="space-y-2">
                  ...
                  <textarea className="input font-mono text-[13px] resize-y" rows={7} value={b.code} onChange={e => setBlock(i, { code: e.target.value })} placeholder="C code the student can run & edit" />
