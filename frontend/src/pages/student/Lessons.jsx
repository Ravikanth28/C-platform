  ...
  return (
    <div className="space-y-5 animate-fade-in max-w-5xl">
      <div>
        ...
        <p className="section-sub mt-0.5">Learn C step by step — read a concept, run real code, check yourself.</p>
      </div>
  ...
  return (
    <div className="card">
      ...
      <div className="rounded-lg overflow-hidden border border-line">
        <Editor height="200px" defaultLanguage="c" theme={isDark ? 'vs-dark' : 'light'}
