...
Run from: I:\Projects\C-platform\backend
  py seed.py
"""
import sys, os
...
if db.query(Note).count() == 0:
    notes_data = [
        ("Introduction to C Programming",
         "Covers variables, data types, input/output using printf/scanf.",
         "youtube", None, "https://www.youtube.com/watch?v=KJgsSFOSQv0"),
        ("Pointers in C",
         "Deep dive into pointer arithmetic, arrays and memory.",
         "link", None, "https://www.geeksforgeeks.org/c-pointers/"),
        ("Strings and String Functions",
         "String handling functions: strlen, strcpy, strcat, strcmp.",
         "link", None, "https://www.tutorialspoint.com/c_standard_library/string_h.htm"),
    ]
...
if db.query(Problem).filter(Problem.mode == "test").count() == 0:
    ...
    test_p = Problem(
        ...
        description="This is a timed proctored test covering C programming fundamentals.\n\nRead an integer N and print whether it is Even or Odd.\n\nExample:\nInput: 4\nOutput: Even\n\nInput: 7\nOutput: Odd",
