...
import schemas
from ai_service import chat_completion, generate_c_problem
...
async def tutor(payload: TutorRequest, _user=Depends(get_current_user)):
    """A C tutor that gives hints/explanations — never the full solution."""
    system = (
        "You are a friendly, concise C programming tutor on a learning platform. "
