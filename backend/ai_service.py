...
async def generate_c_problem(
    topic: str,
    difficulty: str = "medium",
    extra: Optional[str] = None,
) -> dict:
    """Ask the AI to create a complete C programming problem with test cases."""

    system = (
        "You are an expert C programming problem author for a competitive coding platform. "
        "Always return valid JSON only – no markdown fences, no commentary."
    )

    prompt = f"""Create a C programming problem.
Topic: {topic}
